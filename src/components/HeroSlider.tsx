...
const HeroSlider = () => {
  return (
    <Swiper
      ...
      loop
      className="h-[500px] sm:h-[600px] md:h-[700px] lg:h-[800px] relative"
    >
      {slides.map((slide, index) => (
        <SwiperSlide key={index}>
          <div className="relative h-full">
            ...
            >
              <div className="max-w-2xl lg:max-w-4xl text-white">
                ...
                <p className="text-lg sm:text-xl mb-6 sm:mb-8 max-w-prose">
                  {slide.description}
                </p>
                <button className="bg-blue-600 text-white px-6 py-2 sm:px-8 sm:py-3 rounded-md text-sm sm:text-lg font-semibold hover:bg-blue-700 transition-colors">
                  Find a Doctor
                </button>
              </div>
            </motion.div>
